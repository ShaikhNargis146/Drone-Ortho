...
module.exports = {
    ...
    getAutocad: function (req, res) {
        ...
        var id = req.param("id");
        var filePath = "/mymountpoint/" + id + "/" + name + "/3_dsm_ortho/extras/contours/" + name + "_elev2m_res40cm_size20_DSM.dxf";
    ...
    getContourLines: function (req, res) {
        ...
        var name = req.param("filename").split('.')[0]
        var id = req.param("id");
        var filePath = "/mymountpoint/" + id + "/" + name + "/3_dsm_ortho/extras/contours/" + name + "_elev2m_res40cm_size20_DSM.shp";
        files = fs.readFileSync(filePath);
        res.send(files);
    },
    ...
    getContourPdf: function (req, res) {
        ...
        var name = req.param("filename").split('.')[0];
        var id = req.param("id");
        var filePath = "/mymountpoint/" + id + "/" + name + "/3_dsm_ortho/extras/contours/" + name + "_elev2m_res40cm_size20_DSM.pdf";
        files = fs.readFileSync(filePath);
        res.send(files);
    },
