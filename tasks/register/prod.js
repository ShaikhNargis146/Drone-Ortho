...
module.exports = function (grunt) {
    grunt.registerTask('prod', ['copy:assets', 'sass:backendDevelopment', 'copy:backendDevelopment', 'copy:jsBackendDevelopment', 'sass:development', 'copy:jsDevelopment', 'copy:development']);
};